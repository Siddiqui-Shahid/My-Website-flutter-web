...
import 'package:untitled2/IosIconWeb.dart';
import 'package:url_launcher/url_launcher.dart';

import 'IosIconMobile.dart';
...
class MobileWeb extends StatefulWidget {
  const MobileWeb({Key? key}) : super(key: key);

  @override
  _MobileWebState createState() => _MobileWebState();
}
                        ...
                        onTap: () => showCupertinoDialog(
                          ...
                          builder: (context) {
                            return CupertinoAlertDialog(
                              ...
                              content: const Text(
                                  "Are you sure you want to mail Shahid Siddiqui's Github?"),
                              actions: [
                                CupertinoDialogAction(
                                    child: const Text("YES"),
                                    onPressed: () {
                            ...
                            return CupertinoAlertDialog(
                              ...
                              actions: [
                                CupertinoDialogAction(
                                    ...
                                    onPressed: () {
                                      setState(() {
                                        _launched = _launchInBrowser(toMail);
                                        Navigator.of(context).pop();
                                      });
                                    }),
                                CupertinoDialogAction(
